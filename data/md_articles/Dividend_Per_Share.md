# Understanding Dividend Per Share (DPS): Definition, Formula, and Importance
...
3. **Dividend Policy:** Changes in DPS can show a company's dividend policy. Increases may indicate a commitment to shareholder returns, while cuts might mean financial stress.
...
where:
- $\text{D} = \text{sum of dividends over a period (usually}$
- $\text{a quarter or year)}$
- $\text{SD} = \text{special, one-time dividends in the period}$
- $\text{S} = \text{ordinary shares outstanding for the period}$
...
**Know Your Dividend Metrics**

| Metric                     | Description                                                                            | Formula                                                  | What It Means                                                                                                                        |
|----------------------------|----------------------------------------------------------------------------------------|----------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| Dividend Coverage Ratio    | Measures how many times a company can pay its dividends from net income.               | Earnings per Share / Dividends per Share                 | Indicates dividend safety and room for growth.                                                                                       |
| Dividend Frequency         | How often dividends are paid.                                                          | N/A (usually quarterly, semi-annually, or annually)      | Affects planning for income investors.                                                                                               |
| Dividend Growth Rate       | Rate at which DPS increases over time.                                                 | ((DPS in Current Year / DPS in Previous Year) − 1) × 100 | Suggests company’s dividend policy and growth.                                                                                       |
| Dividend Payout Ratio      | Shows the percentage of earnings distributed to shareholders as dividends.             | (Dividends per Share / Earnings per Share) × 100         | High-growth companies typically have lower payout ratios; mature companies often have higher ratios, returning more to shareholders. |
| Dividend Per Share (DPS)   | Amount of dividend paid per outstanding share.                                         | Total Dividends Paid / Number of Outstanding Shares      | Measures the cash returned to shareholders.                                                                                          |
| Dividend Reinvestment Rate | The rate at which dividends are reinvested into purchasing more shares of the company. | (Amount Reinvested / Total Dividends Paid) × 100         | Shows investor confidence and compound growth potential.                                                                             |
| Dividend Yield             | Indicates how much a company pays out in dividends relative to its stock price.        | (Annual Dividends per Share / Price per Share) × 100     | Indicates income return relative to investment.                                                                                      |
| Payout Ratio               | Proportion of earnings paid as dividends.                                              | (DPS / Earnings per Share) × 100                         | Indicates amount of earnings directed toward dividends, not growth.                                                                  |
| Retention Ratio            | The proportion of earnings retained in the business rather than paid out as dividends. | 1 − Payout Ratio                                         | Indicates reinvestment for future growth.                                                                                            |
