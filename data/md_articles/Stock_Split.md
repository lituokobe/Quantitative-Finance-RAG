...
- Through a stock split, a company increases the number of its outstanding shares to boost the stock's liquidity.
...
**Stock Splits: Before and After**

2-for-1 Split:

| Metric            | Pre-Split | Post-Split |
|-------------------|----------|------------|
| Number of Shares  | 10M      | 20M        |
| Share Price       | \$10     | \$5        |
| Market Cap        | \$10B    | \$10B     |
...
| Metric            | Pre-Split | Post-Split |
|-------------------|-----------|------------|
| Number of Shares  | 10M       | 15M        |
| Share Price       | \$10      | \$6.66     |
| Market Cap        | \$10B     | \$10B      |

Example: Nvidia (10-for-1 Split):

| Metric            | Pre-Split    | Post-Split |
|-------------------|--------------|------------|
| Split             | 10-for-1     |            |
| Date              | June 7, 2024 |            |
| Number of Shares  | 2.5B         | 25B        |
| Share Price       | \$1,258.30   | \$128.20   |
| Market Cap        | \$3.15T      | \$3.23T    |
...
1. **The best trading range:** Companies split their stock to keep the share price within a perceived best range that balances the needs of different investor types. That is, specific prices might appear strange or outlandish to investors.
2. **Lower prices attract more investors:** A lower post-split price is more accessible to retail investors.
3. **Liquidity hypothesis:** As we've seen, many argue that stocks trading at lower prices after a split are more liquid, attracting more investors and increasing trading volume.
...
6. **Tick size hypothesis:** In markets with fixed minimum price increments, i.e., ticks, splits can effectively increase the relative tick size, potentially benefiting market makers and improving liquidity.
...
While none of these suggest entirely rational decisions by traders, a more prosaic and far less flattering depiction of investors is that they don't do math well. For this reason, some may struggle to adjust their valuation models properly for the new share structure enough to produce the anomaly.
...
- Finally, the distribution date is when the new shares are actually issued and begin trading at the post-split price.
...
In June 2024, Nvidia Corp (NVDA) split its shares ten-for-one. Right before the split, each share was trading at around \$ 1,200. After the split, the price per share at market open was about \$120 (approximately \$1200 ÷ 10). An investor who owned 1,000 shares of the stock before the split would have owned 4,000 shares after the split. Nvidia's outstanding shares increased to over 24 billion, while its market capitalization reached over \$3 trillion.

A company may split its stock as many times as it would like. Nvidia has completed six forward splits since its initial public offering (IPO) in January 1999.

### Tip

To figure out how many post-split shares come from one original share, you multiply the ratios of each split together. For example, when Nvidia executed a 3-for-2 split in 2001, each share was converted into 1.5 shares (3 ÷ 2 = 1.5).

Using this method, a single Nvidia share purchased before its first split in 1999 would have turned into 480 shares after the most recent 10-for-1 split in June 2024. That total is calculated by multiplying all the split ratios: (2 × 2 × 1.5 × 2 × 4 × 10).
...
**Walmart Inc.'s (WMT) Stock Splits Since Its Initial Public Offering**

| #  | Stock Split        | Split Ratio | Shares   | Split Date Mkt. Price | Record Date     | Distributed     |
|----|--------------------|-------------|----------|-----------------------|------------------|------------------|
| 1  | On the Offering    | 2:1         | 300,000  |                       |                  |                  |
| 2  | May 1971           | 2:1         | 600,000  | \$47.00               | May 19, 1971     | Jun 11, 1971     |
| 3  | March 1972         | 2:1         | 1.2M     | \$47.50               | Mar 22, 1972     | Apr 5, 1972      |
| 4  | August 1975        | 2:1         | 2.4M     | \$23.00               | Aug 19, 1975     | Aug 22, 1975     |
| 5  | Nov. 1980          | 2:1         | 4.8M     | \$50.00               | Nov 25, 1980     | Dec 16, 1980     |
| 6  | June 1982          | 2:1         | 9.6M     | \$49.88               | Jun 21, 1982     | Jul 9, 1982      |
| 7  | June 1983          | 2:1         | 19.2M    | \$81.63               | Jun 20, 1983     | Jul 8, 1983      |
| 8  | September 1985     | 2:1         | 38.4M    | \$49.75               | Sep 3, 1985      | Oct 4, 1985      |
| 9  | June 1987          | 2:1         | 76.8M    | \$66.63               | Jun 19, 1987     | Jul 10, 1987     |
| 10 | June 1990          | 2:1         | 153.6M   | \$62.50               | Jun 15, 1990     | Jul 6, 1990      |
| 11 | Feb. 1993          | 2:1         | 307.2M   | \$63.63               | Feb 2, 1993      | Feb 25, 1993     |
| 12 | March 1999         | 2:1         | 614.4M   | \$89.75               | Mar 19, 1999     | Apr 19, 1999     |
| 13 | Feb. 2024          | 3:1         | 1.229B   | \$175.56              | Feb 22, 2024     | Feb 23, 2024     |
