...
$$RRR = (\text{Expected dividend payment} / \text{Share Price}) + \text{Forecasted dividend growth rate}$$
...
$$RRR = \text{Risk-free rate of return} + \text{Beta} * (\text{Market rate of return} - \text{Risk-free rate of return})$$
