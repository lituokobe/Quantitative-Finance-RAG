...
- New projects should always generate a return that exceeds an initiative's cost of capital.
- The cost of capital is used to set a hurdle rate, the minimum rate of return a company expects to receive from an investment or project.
- A highly innovative but risky initiative should carry a higher cost of capital than a project to update existing equipment.
...
The numbers vary widely. For example, according to a compilation from New York University's Stern School of Business, homebuilding has a relatively high cost of capital compared to the retail grocery business lower cost.
