...
The increase in the Consumer Price Index for All Urban Consumers (CPI-U) over the 12 months ending August 2025 on an unadjusted basis. Prices increased by 0.4% on a seasonally adjusted basis in August 2025 from the previous month.
...
$$\text{Percent Inflation Rate} = (\frac{\text{Final CPI Index Value}}{\text{Initial CPI Value}} - 1) * 100$$
...
$$\text{Adjusted Value} =\frac{\text{Final CPI Index Value}}{\text{Initial CPI Index Value}} * \text{Original Amount}$$
