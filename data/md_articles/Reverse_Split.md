# Reverse Stock Split Explained: Definition, Process, and Real-World Examples

### Key Takeaways

- A reverse stock split consolidates existing shares into fewer, higher-priced shares without changing the company's overall value.
- Companies may conduct reverse stock splits to prevent delisting from major exchanges like the NYSE or Nasdaq.
- Reverse stock splits can indicate financial distress, but they may also attract institutional investors.
- These corporate actions are subject to shareholders' approval through their voting rights.
- While a reverse split raises the stock price, it does not create additional shareholder value.
...
## How Reverse Stock Splits Impact Share Prices and Value
...
## Pros and Cons of Reverse Stock Splits for Companies
...
Exchanges usually set a minimum bid price for a stock to stay listed. If the stock falls below this bid price and remains lower than that threshold level over a certain period, it risks being delisted from the exchange.

For example, Nasdaq may delist a stock consistently trading below \$1 per share. Being removed from a major exchange downgrades the company's shares to penny stocks, which must then be listed on the pink sheets. The shares become harder to buy and sell once placed in these alternative marketplaces for low-value stocks.

**Attract big investors**: Companies often use reverse stock splits to keep share prices high because many institutional investors and mutual funds won't invest in stocks priced too low. Even if a company remains free of delisting risk by the exchange, its failure to qualify for purchase by such large-sized investors mars its trading liquidity and reputation.

**Satisfy regulators**: In different jurisdictions around the globe, a company’s regulation depends upon the number of shareholders, among other factors. By reducing shares, companies can lower shareholder numbers to fit under their preferred regulations or legal requirements. Companies that want to go private may also attempt to reduce the number of shareholders through such measures.

**Boost spinoff prices**:****Companies planning a spinoff might use reverse splits to make their shares more attractive, as spinoffs are formed from selling or distributing shares of a parent company.
...
Generally, the market sees reverse stock splits negatively. It indicates that the company is in distress, the stock price is sinking, and the company's management is attempting to inflate the prices artificially without creating any shareholder value in the process. Additionally, the stock's liquidity may take a hit as the number of shares is reduced in the open market, leading to higher bid-ask spreads and higher transaction costs for investors.

## Application: Reverse Stock Split Example
...
When a public company combines its shares, it's called a reverse stock split, also known as stock consolidation, stock merge, or share rollback. It increases the price per share without changing the company's overall market value.
