...
- $PV = \text{the present value of the investment}$
- $i = \text{the stated interest rate}$
- $n = \text{the number of compounding periods}$
- $t = \text{the time in years}$
...
$$\text{Future Value}(FV) = PV * [1 + (i / n)]^{(n * t)}$$
...
- Annual Compounding: $FV = \$10,000 * (1 + (15\% / 1)) ^{(1 * 1)} = \$11,500$
- Semi-Annual Compounding: $FV = \$10,000 * (1 + (15\% / 2)) ^{(2 * 1)} = \$11,556.25$
- Quarterly Compounding: $FV = \$10,000 * (1 + (15\% / 4)) ^{(4 * 1)} = \$11,586.50$
- Monthly Compounding: $FV = \$10,000 * (1 + (15\% / 12)) ^{(12 * 1)} = \$11,607.55$
- Daily Compounding: $FV = \$10,000 * (1 + (15\% / 365)) ^{(365 * 1)} = \$11,617.98$
- Continuous Compounding: $FV = \$10,000 * 2.7183 ^{(15\% * 1)} = \$11,618.34
$
...
- Discounted Cash Flow Analysis: Though less common in everyday corporate finance, continuous discounting is sometimes used in theoretical DCF models. This approach assumes that future cash flows are being discounted continuously, offering a more refined present value estimate.
