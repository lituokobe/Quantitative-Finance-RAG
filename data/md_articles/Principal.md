...
- Principal is the baseline sum in financial transactions: the initial amount invested or borrowed.
- Principal is the basis for calculating returns, interest, and fees.
- Understanding the concept of principal is crucial for knowing how interest accrues for loans and investments.
- Interest is calculated as a percentage of the principal amount when it’s compounded or simple.
- The principal of a mortgage is the amount borrowed to buy a property. The borrower will repay the principal along with interest over the life of the mortgage.
...
2. Outstanding Principal: A portion of each payment is applied toward reducing the principal as you make payments on your loan. The remaining balance is referred to as the outstanding principal, and it continues to accrue interest until the loan is fully paid off.
...
The size of the principal amount is directly proportional to the overall cost of the loan. A higher principal will result in higher interest payments over the life of the loan, assuming that the interest rate and loan term remain constant.
...
- The original sum of money borrowed in a loan or placed into an investment
- The foundation for calculating interest on a loan or for the returns on an investment
- The face value of a bond that will be returned to the bondholder when the bond matures
- The leader of a company or the primary parties involved in legal contracts

## How Interest Affects Principal

The amount of interest you pay on a loan is determined by the principal amount. The larger the principal, the higher your interest payments will be.
...
- Suppose you borrow \$100,000 at a simple interest rate of 5% per year for two years. The interest for the first year would be \$100,000 × 0.05 = \$5,000. It would be the same for the second year. You would end up repaying \$100,000 in principal + 2 × \$5,000 in interest for a total of \$110,000.
- The interest for the first year remains at \$5,000 with a compound interest loan with the same initial terms. The interest would be calculated based on \$105,000 in the second year: the initial principal plus the first year’s interest, which would be \$100,500 × 0.05 = \$5,250. You would repay \$105,00 + \$5,250 = \$110,250, or \$250 more than you would have with simple interest.
...
2. Interest Costs: The interest rate adds to your debt burden, but the real cost of this interest may be lower than it initially appears in an environment with positive inflation.
...
- The real value of that \$15,000 at the end of 10 years, adjusted for 3% annual inflation, would be approximately $\$15,000 / (1 + 0.03)^{10} = \$11,162.37$.
...
1. Final Value of Investment: This is the value of the investment at the end of the period you’re examining. It includes any profits made and dividends received and subtracts any losses or costs associated with the investment.
