...
$$\textbf{Future Value} = \textbf{Present Value }*(1+\textbf{interest rate%)})$$
*for one year*
...
$$\textbf{Present Value}=\frac{\textbf{Future Value}}{(1+\textbf{interest rate}\%)}$$
...
$$\textbf{Value of Stock}=\frac{\textbf{EDPS}}{(\textbf{CCE}-\textbf{DGR})}$$
where:
- $EDPS=\text{expected dividend per share}$
- $CCE=\text{cost of capital equity}$
- $DGR=\text{dividend growth rate}$
...
- $D = \text{the estimated value of next year's dividend}$
- $r = \text{the company's cost of capital equity}$
- $g = \text{the constant growth rate for dividends, in perpetuity}$
...
$\text{Price per share} = D(1) / (r - g)$

$\text{Price per share} = \$1.89 / ( 7\% - 5\%)$

$\text{Price per share} = \$94.50$
