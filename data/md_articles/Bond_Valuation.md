...
$$V_{\text{coupons}}=\sum\frac{C}{(1+r)^t}$$
$$V_{\text{face value}}=\frac{F}{(1+r)^T}$$
where:
- $C=\text{future cash flows, that is, coupon payments}$
- $r=\text{discount rate, that is, yield to maturity}$
- $F=\text{face value of the bond}$
...
- $F = \$1,000 \text{for corporate bond}$
- $\text{Coupon rate}_\text{annual} = 5\%\text{, therefore, Coupon ratesemi-annual} = 5\% / 2 = 2.5\%$
- $C = 2.5\% * \$1000 = \$25 \text{ per period}$
- $t = 2 \text{ years} * 2 = 4\text{ periods for semi-annual coupon payments}$
- $T = 4 \text{ periods}$
- $r = \text{YTM of } 3\% / 2\text{ for semi-annual compounding} = 1.5\%$

1. $\text{Present value of semi-annual payments} = 25 / (1.015)^1 + 25 / (1.015)^2 + 25 / (1.015)^3 + 25 / (1.015)^4 = 96.36$
2. $\text{Present value of face value} = 1000 / (1.015)^4 = 942.18$
...
A bond is an investment that returns a fixed interest rate. When you buy a bond, you receive periodic interest payments until the bond matures, and then the face value of the bond is returned to you.
