...
- You buy them at a discount to face value and receive the full face amount at maturity; the difference constitutes your return (they don’t pay periodic interest).
- Investors can buy T-bills in electronic form from TreasuryDirect, the U.S. Treasury's platform.
- Interest from T-Bills is subject to federal income tax but is exempt from state and local taxes – an important tax advantage, especially in high-tax states.

## What Is a Treasury Bill?

A Treasury bill (T-bill) is a short-term U.S. government debt obligation with terms ranging from four to 52 weeks. T-bills are issued at a discount from the par value, also known as the face value.

Treasury bills are usually sold in denominations of \$100. However, some can reach a maximum denomination of \$10 million in non-competitive bids. The Treasury sells T-bills during auctions using competitive and non-competitive bidding processes.

## How to Buy Treasury Bills

The U.S. Department of the Treasury issues T-bills to raise cash to fund the federal government's spending. T-bills are generally held either until the maturity date or cashed before maturity. Investors can buy T-bills in electronic form from a brokerage firm, generally with a small fee, or directly from TreasuryDirect, the online platform of the U.S. Treasury. Here are the steps to do so:
...
6. Verify your account: After verification, log in and click on the "Buy Direct" tab.
...
Treasury bill maturity dates are available in four, six, eight, 13, 17, 26, and 52 weeks. When interest rates are expected to rise, longer maturity dates pay more than shorter dates. Meanwhile, if rates are expected to fall, longer maturity dates might have lower interest rates. Below is a chart of the four-week, six-month, and one-year T-bill yields for the last 10 years.

## Redemptions and Interest

T-bills are issued at a discount from the par value. When the bill matures, the investor is paid the face value (also called the par value) of the bill. Since the face value exceeds the purchase price, the difference is the interest earned.
...
T-bills don't offer the regular interest payments that coupon bonds do, but they include built-in interest reflected in the amount they pay when they mature. The interest income from T-bills is exempt from state and local income taxes, but it is subject to federal income tax.
...
If sold early, there could be a gain or loss depending on where bond prices trade at the time of the sale. The sale price of the T-bill could be lower than the original purchase price.
...
| Decreases       | Goes down                | Buy existing T-bills   |
...
4. **Effective yield:** The effective yield, or ROI, would be approximately 5.26% (since you earned \$50 on an initial investment of \$950 over one year).

**Know Your Treasury Terms**

| Term                                           | Definition                                                                                                              |
|------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| Auction                                        | The process by which new Treasury securities are sold to the public.                                                    |
| Coupon Rate                                    | The fixed annual interest rate paid by the Treasury security.                                                           |
| CUSIP                                          | Committee on Uniform Securities Identification Procedures number, a unique identifier for a Treasury security.          |
| Face Value (Par Value)                         | The amount printed on the Treasury security, which will be paid at maturity.                                            |
| Treasury Inflation-Protected Securities (TIPS) | Treasury securities that adjust the principal value with inflation to protect against purchasing power loss.            |
| Maturity                                       | The date when the principal amount of the Treasury security becomes due and is repaid to the investor.                  |
| Primary Dealer                                 | Financial institutions authorized to trade directly with the U.S. Federal Reserve and participate in Treasury auctions. |
| Secondary Market                               | Where previously issued Treasury securities are bought and sold among investors.                                        |
| Treasury Bills (T-Bills)                       | Short-term government securities that mature in one year or less, sold at a discount.                                   |
| Treasury Bonds (T-Bonds)                       | Long-term government securities with maturities of more than 10 years, paying semiannual interest.                      |
| Treasury Notes (T-Notes)                       | Medium-term government securities with maturities between two and 10 years, paying semiannual interest.                 |
| Yield                                          | The return on investment for a Treasury security, expressed as an annual percentage of the purchase price.              |
| Yield Curve                                    | A graph showing the relationship between yields and maturity dates for a set of similar bonds.                          |

## How Does Inflation Affect Treasury Bills?

Treasury bills also have to compete with inflation, which is the pace of rising prices. Even if T-bills are the most liquid and safest debt security in the market, fewer investors tend to buy them when the inflation rate is higher than the T-bill's returns.
...
Treasury bills are one of several types of debt issued by the Treasury Department. Treasury bonds and Treasury notes are fixed-term debt. Treasury bills are short-term obligations, up to a year. Treasury notes are medium-term securities, from two to 10 years. Treasury bonds have the longest time frame, maturing in 20 or 30 years. The U.S. Treasury also issues Treasury Inflation-Protected Securities (TIPS), which are linked to changes in the consumer price index.
