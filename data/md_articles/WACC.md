...
Weighted average cost of capital (WACC) is a vital metric for assessing a company's financing costs by averaging the after-tax cost of all capital sources like equity and debt. Investors use WACC to determine the required rate of return (RRR), and companies rely on it to evaluate potential projects and acquisitions. A higher WACC indicates riskier investments, demanding greater returns. This article unpacks WACC's calculation, its role in corporate finance, and its significance in investment decisions.

### Key Takeaways

- Weighted Average Cost of Capital (WACC) is a critical financial metric that combines the cost of equity and debt, reflecting the average rate a company must pay to finance its business.
- WACC is widely used by investors and company management as it serves both as a discount rate in cash flow analysis and as a benchmark for evaluating investment opportunities.
- Calculating WACC involves determining the market value proportions of debt and equity financing, and it accounts for tax advantages associated with interest expenses.
- While WACC provides valuable insights into a company's financial health, its calculation can be complex due to varying assumptions and requires careful consideration of market conditions and inputs.

### Investopedia Answers

## Demystifying WACC

Calculating a company's WACC helps investors, stock analysts, and company managers. Each group uses it differently.

In corporate finance, determining a company's cost of capital can be important for several reasons. For example, WACC can serve as the discount rate when estimating a project's or acquisition's net present value.
...
To investors, WACC is an important tool in assessing a company's potential for profitability. Generally, a lower WACC suggests a healthy business that can attract investors more cheaply. A higher WACC often indicates riskier businesses that must offer higher returns to attract investors.
...
The same would be true if the company only used debt financing. For example, if the company paid an average yield of 5% on its bonds, its pre-tax cost of debt would be 5%. But interest payments are tax-deductible, so the after-tax cost of debt would be lower, at 5% × (1 - tax rate). This after-tax cost of debt would also represent the company's cost of capital in this scenario, since all the capital is debt.
...
$$\text{WACC} = \left ( \frac{ E }{ V} * Re \right ) + \left ( \frac{ D }{ V} * Rd * ( 1 - Tc ) \right )$$ 
where:
- $\text{Market value of the firm's equity}$ 
...
WACC is calculated by multiplying the cost of each capital source (debt and equity) by its relevant weight and then adding those results together. In the formula, E/V shows the proportion of equity financing, and D/V represents the proportion of debt financing. The WACC formula thus involves the summation of two terms:

$$\left( \frac{ E }{ V} * Re \right)$$

$$\left( \frac{ D }{ V} * Rd * ( 1 - Tc ) \right )$$
...
WACC can be calculated using Excel.
...
The required rate of return is the minimum return that an investor will accept in exchange for their investment. If returns are expected to be lower, investors will choose other investments.
...
Calculating WACC is another way to find the RRR. WACC's advantage is that it considers the company's capital structure, balancing debt and equity. This can give a more accurate picture of investors' expectations.
...
- **Complex structures:** Calculating WACC can be tough for companies with complex balance sheets and multiple debt types and interest rates.
...
The best way to use WACC is in combination with other financial metrics. When deciding to invest, always aim to get a full picture of a company's financial health and growth potential.
