...
## Understanding the Fundamentals of Underlying Assets

Underlying assets give derivatives their value. For example, an option on stock XYZ allows the holder to buy or sell it at the strike price until expiration. The underlying asset here is XYZ stock. Many, but not all, stocks have [option chains available](https://www.investopedia.com/ask/answers/06/stockswithoptions.asp).

An underlying asset identifies the item in the agreement that provides contract value. It supports the security involved, which parties agree to [exchange as part of the derivative contract](https://www.investopedia.com/ask/answers/052715/what-kinds-derivatives-are-types-contingent-claims.asp).

## How Derivative Contracts Work with Underlying Assets

The price of an option or [futures](https://www.investopedia.com/terms/f/futures.asp) contract comes from the underlying asset's price. In an option contract, the [writer](https://www.investopedia.com/terms/w/writing-an-option.asp) must buy or sell the asset to the buyer on a specific date at the agreed price. The buyer is not obligated to buy the asset, but they can exercise their right if desired. If the option is expiring and the asset hasn't moved favorably, the buyer can let it expire and lose only the amount paid for the option.
