...
- $TCI = \text{Total cash inflow}$
- $TCO = \text{Total cash outflow}$
...
| Term                                 | Definition                                                                                                    |
|--------------------------------------|---------------------------------------------------------------------------------------------------------------|
| **Free Cash Flow (FCF)**             | A measure of financial performance showing how much money is left after dividends, buybacks, or debt paydown. |
| **Unlevered Free Cash Flow (UFCF)**  | Gross FCF generated before accounting for interest payments.                                                  |
| **Cash Flow-to-Net Income Ratio**    | Ratio of net cash flow to net income, ideally 1:1.                                                            |
| **Current Liability Coverage Ratio** | Assesses ability to cover current liabilities with operating cash flow.                                       |
| **Price-to-Cash Flow Ratio**         | Operating cash flow per share divided by stock price.                                                         |
...
| Proceeds from disposal of property and equipment | 432          | 250          | 170          |
| Proceeds from disposal of strategic investments  | 4,080        | —            | —            |
| Payments for business acquisitions               | (1,896)      | (9)          | (740)        |
...
| Effect of exchange rates on cash                 | (641)        | 69           | (73)         |
| **Net increase (decrease) in cash**              | **(399)**    | **1,094**    | **(5,993)**  |
| Cash at beginning of year                        | 9,935        | 8,841        | 14,834       |
| **Cash at end of year**                          | **9,536**    | **9,935**    | **8,841**    |
