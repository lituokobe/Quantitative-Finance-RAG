...
theme = gr.themes.Soft(
    ...
    block_shadow="0 4px 10px rgba(0,0,0,0.06)",
...
with (gr.Blocks(title='Quantitative Finance Assistant (Adaptive RAG)', theme=theme) as instance): #set up the page title with css, we have an HTML page
    gr.Label('Quantitative Finance Assistant (Adaptive RAG)', container=False) #header of the page
