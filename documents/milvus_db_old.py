...
class MilvusVectorSave:
    ...
    def create_collection(self, recreate:bool=False):
        """
        Use default pymilvus package create a new collection for hybrid search.
        """
        ...
        schema.add_field(
            ...
            nullable=True, # This field can be null during data insertion, as it will be calculated by BM25 later
    ...
    def create_connection(self):
        """
        Use langchain_milvus to create a connection: Milvus + LangChain/LangGraph,
        for the convenience of searching with LangChian/LangGraph.
        This sets up the vector store with:
        - Dense vector field for semantic search
        - Sparse vector field for BM25 keyword search
        - Automatic RRF fusion via as_retriever()
        """
        try:
