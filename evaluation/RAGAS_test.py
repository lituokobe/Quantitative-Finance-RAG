...
print(f"Result of test 1")
print(f"Context precision: {cp_score0:.3f}")
print(f"Context recall: {cr_score0:.3f}")
print(f"Answer relevancy: {ar_score0:.3f}")
print(f"Answer faithfulness: {af_score0:.3f}")
print(f"Answer correctness: {ac_score0:.3f}")
print(f"Result of test 2")
print(f"Context precision:: {cp_score1:.3f}")
print(f"Context recall: {cr_score1:.3f}")
print(f"Answer relevancy: {ar_score1:.3f}")
print(f"Answer faithfulness: {af_score1:.3f}")
print(f"Answer correctness: {ac_score1:.3f}")