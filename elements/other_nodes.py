...
def rewrite_query_node(state: State) -> dict:
    log.info("rewrite_query_node starts to work.")
    ...
    You can analyse and comprehend the true meaning and intention behind the question.
    """
    ...
    log.info("rewrite_query_node finishes working.")
...
def web_search_node(state: State) -> dict:
    log.info("web_search_node starts to work.")
    ...
    log.info("web_search_node finishes working.")
